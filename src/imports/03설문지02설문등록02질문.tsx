import svgPaths from "./svg-ddk9d4zuay";
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="03 설문지_02 설문등록_02 질문">
      <div className="absolute bg-white content-stretch flex flex-col gap-[8px] h-[1233px] items-start left-0 px-[16px] py-[20px] top-[60px] w-[304px]" data-name="LNB">
      ...
      <div className="absolute content-stretch flex flex-col gap-[36px] items-start left-[536px] top-[168px] w-[1152px]" data-name="contents">
          ...
          <div className="basis-0 flex flex-row grow items-center self-stretch shrink-0">
            <div className="basis-0 content-stretch flex gap-[4px] grow h-full items-center justify-end min-h-px min-w-px relative shrink-0" data-name="btn">
              ...
              <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[2px] h-[32px] items-center justify-center px-[12px] py-0 relative rounded-[8px] shrink-0" data-name="Label Button">
                ...
                <p className="font-['Pretendard_Variable:SemiBold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(12,15,15,0.71)] text-nowrap tracking-[-0.042px]">유형 저장</p>
              </div>
            </div>
          </div>
        </div>
        <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full" data-name="contents">
                ...
                <div className="bg-white h-[490px] relative rounded-[12px] shrink-0 w-full" data-name="card">
                  ...
                  <div className="size-full">
                    <div className="content-stretch flex gap-[13px] items-start pl-[48px] pr-[40px] py-[32px] relative size-full">
                      <Wrapper2 additionalClassNames="absolute left-[14px] top-[39px]">
                        <g id="ic_drag">
