import svgPaths from "./svg-go4nhcjxrw";
import clsx from "clsx";

function Wrapper7({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="size-full">
      <div className="content-stretch flex gap-[13px] items-start pl-[48px] pr-[40px] py-[32px] relative size-full">{children}</div>
    </div>
  );
}
type Wrapper6Props = {
...
function IcDelete1({ children }: React.PropsWithChildren<{}>) {
  return (
    <Wrapper3>
      <g id="ic_delete">{children}</g>
    </Wrapper3>
  );
}

function InputBox2({ children }: React.PropsWithChildren<{}>) {
  return (
    <Wrapper2>
  ...
  return (
    <div className="basis-0 bg-white grow min-h-[120px] min-w-px relative rounded-[8px] shrink-0 w-full">
      <div className="min-h-[inherit] overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[12px] items-start min-h-[inherit] p-[12px] relative size-full">{children}</div>
      </div>
      <div aria-hidden="true" className="absolute border border-[rgba(12,15,15,0.19)] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function DataByte({ text, text1, text2 }: DataByteProps) {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-end leading-[20px] not-italic relative shrink-0 text-[14px] text-nowrap tracking-[-0.042px]">
      <p className="font-['Pretendard_Variable:Regular',sans-serif] relative shrink-0 text-[rgba(12,15,15,0.52)]">{text}</p>
      <p className="font-['Pretendard_Variable:SemiBold',sans-serif] relative shrink-0 text-[#2a2c2c]">{text1}</p>
      <p className="font-['Pretendard_Variable:Regular',sans-serif] relative shrink-0 text-[rgba(12,15,15,0.52)]">{text2}</p>
    </div>
  );
}
...
function IcClose() {
  return (
    <Wrapper5>
      <g id="ic_close">
        <path d={svgPaths.p38ff5000} fill="var(--fill-0, #2A2C2C)" id="Vector" />
      </g>
    </Wrapper5>
  );
}
...
function IcChevronUp() {
  return (
    <Wrapper6 additionalClassNames="relative shrink-0 size-[20px]">
      <g id="ic_chevron_up">
...
function IcDrag({ additionalClassNames = "" }: IcDragProps) {
  return (
    <Wrapper6 additionalClassNames={clsx("absolute left-[14px] size-[20px]", additionalClassNames)}>
      <g id="ic_drag">
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="02 문항유형_03 리스트 클릭">
      <div className="absolute bg-white content-stretch flex flex-col gap-[8px] h-[1665px] items-start left-0 px-[16px] py-[20px] top-[60px] w-[304px]" data-name="LNB">
        ...
        <div className="content-stretch flex flex-col gap-[36px] items-start relative shrink-0 w-full" data-name="메인정보">
          <div className="content-stretch flex items-center pb-[12px] pt-0 px-0 relative shrink-0 w-full" data-name="page title input">
            ...
            <div className="content-stretch flex items-center relative shrink-0" data-name="test">
              <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[47px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[34px] text-nowrap tracking-[-0.34px]">러닝화 피팅 평가</p>
            </div>
          </div>
        ...
        <div className="content-stretch flex items-start justify-center relative shrink-0 w-full" data-name="문항정보">
          ...
          <div className="basis-0 content-stretch flex flex-col gap-[20px] grow items-center min-h-px min-w-px relative shrink-0" data-name="card">
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="card">
              <div className="bg-white h-[66px] relative rounded-[12px] shrink-0 w-full" data-name="card">
                ...
                <div className="size-full">
                  <div className="content-stretch flex gap-[13px] items-start pl-[48px] pr-[40px] py-[16px] relative size-full">
                      ...
                      <div className="content-stretch flex gap-[16px] items-center justify-end relative shrink-0 w-[425px]">
                        ...
                        <Wrapper6 additionalClassNames="relative shrink-0 size-[20px]">
                          <g id="ic_chevron_down">
                            <path d={svgPaths.p2974e8c0} fill="var(--fill-0, #2A2C2C)" id="Vector" />
                          </g>
                        </Wrapper6>
                      </div>
                    </div>
              ...
              <div className="bg-white h-[490px] relative rounded-[12px] shrink-0 w-full" data-name="card">
                <div aria-hidden="true" className="absolute border border-[rgba(12,15,15,0.19)] border-solid inset-0 pointer-events-none rounded-[12px] shadow-[0px_0px_1px_0px_rgba(13,14,17,0.2),0px_6px_9px_0px_rgba(13,14,17,0.03)]" />
                <Wrapper7>
                        ...
                        <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0" data-name="field">
                          ...
                          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="btn">
                            <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[308px]">
                              <LabelButtonText text="파일 추가" />
                              <DataByte text="총" text1="37.8KB" text2="/50MB" />
                            </div>
                        ...
                        <div className="basis-0 content-stretch flex flex-col grow h-[132px] items-start min-h-px min-w-px relative shrink-0" data-name="Text Area">
                          <Wrapper>
                            <div className="content-stretch flex items-start overflow-clip relative shrink-0 w-full" data-name="input-text-wrap">
                              <p className="basis-0 font-['Pretendard_Variable:Regular',sans-serif] grow leading-[27px] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-[rgba(12,15,15,0.52)] tracking-[-0.08px]">문항에 대한 도움말을 입력해주세요.</p>
                            </div>
                          </Wrapper>
                        </div>
                      </div>
                      <div className="content-stretch flex items-start justify-between relative shrink-0 w-full" data-name="row">
                        ...
                        <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px relative shrink-0" data-name="field">
                          ...
                          <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="btn">
                            <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[308px]">
                              <LabelButtonText text="파일 추가" />
                              <DataByte text="총" text1="0KB" text2="/50MB" />
                            </div>
