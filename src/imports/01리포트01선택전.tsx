import svgPaths from "./svg-fis8uv633v";
...
export default function Component() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="01 리포트_01 선택 전">
                  ...
                  <div className="content-stretch flex flex-col items-center relative shrink-0 w-full" data-name="table/pagenation">
                    ...
                    <div className="content-stretch flex gap-[8px] items-center justify-center pb-0 pt-[20px] px-0 relative shrink-0" data-name="Pagination">
                      ...
                      <div className="content-stretch flex items-center relative shrink-0" data-name="btn right">
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center justify-center px-0 py-[2px] relative rounded-[8px] shrink-0 size-[32px]" data-name="Icon Button">
                          <Wrapper3>
                            <g clipPath="url(#clip0_4_9918)" id="ic_chevron_right">
                              <path d={svgPaths.p11a80500} fill="var(--fill-0, #0C0F0F)" fillOpacity="0.69" id="Vector" />
                            </g>
                            <defs>
                              <clipPath id="clip0_4_9918">
                        ...
                        <div className="bg-[rgba(255,255,255,0)] content-stretch flex items-center justify-center px-0 py-[2px] relative rounded-[8px] shrink-0 size-[32px]" data-name="Icon Button">
                          <Wrapper3>
                            <g clipPath="url(#clip0_4_9897)" id="ic_chevron_double right">
                              <path d={svgPaths.p3588fe00} fill="var(--fill-0, #0C0F0F)" fillOpacity="0.69" id="Vector" />
                              <path d={svgPaths.p18bd3500} fill="var(--fill-0, #0C0F0F)" fillOpacity="0.69" id="Vector_2" />
                            </g>
                            <defs>
                              <clipPath id="clip0_4_9897">
                                <rect fill="white" height="16" width="16" />
                              </clipPath>
                            </defs>
                          </Wrapper3>
