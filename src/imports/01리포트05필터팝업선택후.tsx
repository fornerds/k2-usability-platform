import svgPaths from "./svg-eusl4tclrr";
...
function CheckBox() {
  return (
    <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
      ...
      <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
        <p className="leading-[20px] overflow-ellipsis overflow-hidden">뉴발란스</p>
      </div>
    </div>
  );
}
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="01 리포트_05 필터 팝업 선택후">
      <div className="absolute content-stretch flex flex-col h-[940px] isolate items-center justify-center left-0 overflow-clip px-0 py-[60px] top-0 w-[1920px]" data-name="Modal Example (Detach 해서 사용하세요)">
        <div className="bg-white max-w-[800px] relative rounded-[6px] shrink-0 w-full z-[2]" data-name="modal">
          <div className="content-stretch flex flex-col items-center max-w-[inherit] overflow-clip relative rounded-[inherit] w-full">
            ...
            <div className="content-stretch flex flex-col gap-[28px] items-start px-0 py-[24px] relative shrink-0 w-[752px]" data-name="content">
              <div className="content-stretch flex flex-col gap-[12px] items-start pb-[28px] pt-0 px-0 relative shrink-0 w-full" data-name="브랜드">
                <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(12,15,15,0.13)] border-solid inset-0 pointer-events-none" />
                <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#2a2c2c] text-[16px] tracking-[-0.08px] w-full">브랜드</p>
                <div className="content-center flex flex-wrap gap-[12px] items-center justify-between relative shrink-0 w-full" data-name="wrap">
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">나이키</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">네파</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">노스페이스</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">아이더 세이프티</p>
                    </div>
                  </div>
                  <CheckBox />
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">블랙야크</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">케이투 세이프티</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">데상트</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">부룩스</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">살로몬</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">아디다스</p>
                    </div>
                  </div>
                  <CheckBox />
                </div>
              ...
              <div className="content-stretch flex flex-col gap-[12px] items-start pb-[28px] pt-0 px-0 relative shrink-0 w-full">
                <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(12,15,15,0.13)] border-solid inset-0 pointer-events-none" />
                <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#2a2c2c] text-[16px] tracking-[-0.08px] w-full">시즌</p>
                <div className="content-stretch flex gap-[20px] items-center relative shrink-0 w-full" data-name="segment/select">
                  <div className="basis-0 bg-[rgba(12,15,15,0.07)] grow h-[40px] min-h-px min-w-px relative rounded-[6px] shrink-0" data-name="Segmented Control">
                  ...
                  <div className="basis-0 content-stretch flex flex-col grow isolate items-start min-h-px min-w-px relative shrink-0" data-name="Select">
                    <div className="bg-white h-[40px] relative rounded-[8px] shrink-0 w-full z-[2]" data-name="input-box">
                      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                        <div className="content-stretch flex items-center pl-[12px] pr-0 py-0 relative size-full">
                          <div className="basis-0 content-stretch flex grow items-center min-h-px min-w-px overflow-clip relative shrink-0" data-name="input-wrap">
                            <div className="flex flex-col font-['Pretendard_Variable:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#2a2c2c] text-[16px] text-nowrap tracking-[-0.08px]">
                              <p className="leading-[22px]">2024</p>
                            </div>
                          </div>
                          <div className="overflow-clip relative shrink-0 size-[40px]" data-name="Touch Target">
                            <div className="absolute left-[11px] size-[18px] top-[11px]" data-name="caret_down_bold">
              ...
              <div className="content-stretch flex flex-col gap-[12px] items-start pb-[28px] pt-0 px-0 relative shrink-0 w-full" data-name="브랜드">
                <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-[rgba(12,15,15,0.13)] border-solid inset-0 pointer-events-none" />
                <p className="font-['Pretendard_Variable:Bold',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#2a2c2c] text-[16px] tracking-[-0.08px] w-full">카테고리</p>
                <div className="content-center flex flex-wrap gap-[12px] items-center justify-between relative shrink-0 w-full" data-name="wrap">
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                      <Checkbox1 />
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">경등산화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">골프화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">트레킹화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">하이킹</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">워킹화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">슬리퍼</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">방한화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">안전화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">안전장화</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                    ...
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
                      <p className="leading-[20px] overflow-ellipsis overflow-hidden">스니커즈</p>
                    </div>
                  </div>
                  <div className="basis-0 content-stretch flex gap-[8px] grow items-center max-w-[188px] min-h-px min-w-[188px] opacity-0 relative shrink-0" data-name="check box">
                    <div className="content-stretch flex items-center relative rounded-[8px] shrink-0" data-name="Checkbox">
                      <Checkbox />
                    </div>
                    <div className="flex flex-col font-['Pretendard_Variable:SemiBold',sans-serif] justify-center leading-[0] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[14px] text-nowrap tracking-[-0.042px]">
        ...
        <div className="absolute bg-[rgba(12,15,15,0.52)] inset-0 z-[1]" data-name="dim" />
      </div>
    </div>
  );
}