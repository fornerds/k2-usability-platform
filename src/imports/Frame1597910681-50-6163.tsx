      ...
      <div className="size-full">
        <div className="content-stretch flex flex-col gap-[16px] items-start px-[24px] py-0 relative size-full">
          ...
          <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0">
            ...
            <div 
              data-section="통증 부위"
              className="content-stretch flex items-center pl-[24px] pr-0 py-0 relative shrink-0 cursor-pointer hover:opacity-80"
            >
            ...
            <div data-section="피팅감" className="cursor-pointer hover:opacity-80">
              <Text text="피팅감" additionalClassNames="shrink-0" />
            </div>
            <div data-section="기능성" className="relative shrink-0 w-full cursor-pointer hover:opacity-80">
              <div className="flex flex-row items-center size-full">
                <Text text="기능성" additionalClassNames="w-full" />
              </div>
            </div>
            <div data-section="만족도" className="relative shrink-0 w-full cursor-pointer hover:opacity-80">
              <div className="flex flex-row items-center size-full">
