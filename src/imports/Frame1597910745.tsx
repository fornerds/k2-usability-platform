...
import svgPaths from "./svg-ywdp2sg0uy";
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <div className="content-stretch flex gap-[4px] items-start relative shrink-0 w-full">
        ...
        <div className="absolute content-stretch flex h-[12px] items-center justify-between left-0 opacity-60 px-[12px] py-0 top-[4px] w-[392px]">
        ...
        <div className="absolute bg-white h-[20px] left-[121px] top-0 w-[4px]" />
        <div className="absolute bg-white h-[20px] left-[267px] top-0 w-[4px]" />
      </div>
...
export default function Frame() {
  ...
  const productData = [
    { name: "가드런 맥스", score: "-40", totalCount: "19건", loose: "2건", fit: "14건", tight: "3건", position: "calc(50%-146px)" },
    { name: "피스테런 3.0", score: "0", totalCount: "15건", loose: "1건", fit: "12건", tight: "2건", position: "1/2" },
    { name: "스위프트인터벌", score: "35", totalCount: "12건", loose: "3건", fit: "7건", tight: "2건", position: "calc(50%+129px)" }
  ];
            ...
            >
              ...
              <div className="basis-0 content-stretch flex flex-col grow items-start justify-center min-h-px min-w-px relative rounded-tl-[12px] rounded-tr-[12px] shrink-0 w-full">
                <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
                  <p className="-webkit-box font-['Pretendard_Variable:Medium',sans-serif] leading-[17px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[12px] text-[rgba(12,15,15,0.52)] w-full">
                    {product.name}
                  </p>
                  <p className="-webkit-box font-['Pretendard_Variable:SemiBold',sans-serif] leading-[22px] not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#2a2c2c] text-[16px] tracking-[-0.08px] w-full">
                    {product.score}
                  </p>
                  <BackgroundImage />
                  {index === 0 && (
                    <div className="absolute contents left-[calc(50%-146px)] top-[7.15px] translate-x-[-50%]">
                  ...
                  {index === 1 && (
                    <div className="absolute contents left-1/2 top-[6.01px] translate-x-[-50%]">
                  ...
                  {index === 2 && (
                    <div className="absolute contents left-[calc(50%+129px)] top-[6.01px] translate-x-[-50%]">
