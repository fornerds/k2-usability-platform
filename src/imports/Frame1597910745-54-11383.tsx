...
function IcInfoBackgroundImage() {
  return (
    <div className="absolute right-[20px] size-[20px] top-[20px]">
      ...
      <div className="content-stretch flex flex-col gap-[16px] items-center relative rounded-[12px] shrink-0 w-full">
        ...
        <div className="content-stretch flex gap-[24px] items-start relative rounded-[12px] shrink-0 w-full">
          ...
          <BackgroundImage3>
            ...
            <IcInfoBackgroundImage />
            <div className="absolute content-stretch flex gap-[4px] items-center left-[-519px] top-[-18px]" data-name="tooltip">
              <div className="shadow-[0px_1.469px_4.406px_0px_rgba(0,0,0,0.1),0px_1.469px_2.938px_-1.469px_rgba(0,0,0,0.1)] shrink-0 size-[47px]" data-name="Util / Cursor & Interaction" />
              <div className="bg-white content-stretch flex flex-col gap-[4px] items-start p-[12px] relative rounded-[8px] shrink-0 w-[136px]">
                ...
                <BackgroundImage2 text="총 응답수" text1="12건" />
                <BackgroundImage2 text="헐거움" text1="3건" />
                <BackgroundImage2 text="적당함" text1="7건" />
                <BackgroundImage2 text="압박감" text1="2건" />
