type DeleteSurveyDetailModalProps = {
  onCancel: () => void;
  onConfirm: () => void;
};

export default function DeleteSurveyDetailModal({ onCancel, onConfirm }: DeleteSurveyDetailModalProps) {
  return (
            ...
            <div className="overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex flex-col items-start p-[24px] relative w-full">
                <p className="leading-[27px] not-italic relative shrink-0 text-[#2a2c2c] text-[16px] text-center tracking-[-0.08px] w-full">
                  삭제를 선택하면 해당 설문은 즉시 삭제되며, 복구 할 수 없습니다.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white relative shrink-0 w-full">
            <div className="size-full">
              <div className="content-stretch flex gap-[8px] items-start pb-[16px] pt-[12px] px-[16px] relative w-full">
                ...
                <button
                  onClick={onConfirm}
                  className="basis-0 bg-[#1e2020] grow h-[40px] min-h-px min-w-px relative rounded-[8px] shrink-0 hover:bg-[#0a0a0a] transition-colors"
                >
                  <div className="flex flex-row items-center justify-center size-full">
                    <div className="content-stretch flex gap-[4px] items-center justify-center px-[20px] py-0 relative size-full">
